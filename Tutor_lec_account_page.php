<?php 
  ...
  session_start();
    ...
    if (isset($_POST['update_tut_profile'])) {
    ...
    if($result) {
      ...
      echo "<script>alert('Updated successfully!'); location.href ='Tutor_lec_account_page.php';</script>";
      }else{
  
        echo "<script>alert('unsuccessfull, Try Again!'); location.href ='Tutor_lec_account_page.php';</script>";
      }
...
if (isset($_POST['update_password'])) {
  ...
  if($result) {
    ...
    echo "<script>alert(' Password Updated successfully!'); location.href ='Tutor_lec_account_page.php';</script>";
    }else{

      echo "<script>alert('Try Again!'); location.href ='Tutor_lec_account_page.php';</script>";
    }
...
<head>
  ...
  <title>UDW | Tut&Lecture Home</title>
...
<?php
                    ...
                    <div class="card">
                        <h5 class="card-header">profile</h5>
                         <div class="card-body">
                          ...
                          <form id="login" action="Tutor_lec_account_page.php" method="POST">
                                <div class="form-row">
                                  <div class="form-group col-md-6">
                                      ...
                                      <div class="form-group">
                                        <button type="submit" class="btn-primary" name="update_tut_profile">UPDATE</button>
                                      </div>
                                    </form>
                    </div>
                  </div>
          ...
          <div class="card" style="width: 30rem;">
            <div class="card-body">
              ...
              <form action="Tutor_lec_account_page.php" method="POST" onsubmit="return validation()">
