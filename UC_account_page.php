<?php 
  ...
  session_start();
    ...
    if (isset($_POST['update_UC_profile'])) {
    ...
    $sql = "UPDATE `Staffs` SET `email`='$email2',`address`='$address2', `qualification`='$qualification', `expertise`='$expertise',`phone`='$phn2' WHERE `username` ='".$_SESSION['username2']."' ";
    ...
    if($result) {
      ...
      echo "<script>alert('Updated successfully!'); location.href ='UC_account_page.php';</script>";
      }else{
  
        echo "<script>alert('unsuccessfull, Try Again!'); location.href ='UC_account_page.php';</script>";
      }
...
if (isset($_POST['update_password'])) {
  ...
  if($result) {
    ...
    echo "<script>alert(' Password Updated successfully!'); location.href ='UC_account_page.php';</script>";
    }else{

      echo "<script>alert('Try Again!'); location.href ='UC_account_page.php';</script>";
    }
...
<head>
  ...
  <title>UDW | UC-Account Page</title>
        ...
        ?>
          ...
          while ($row =$result->fetch_assoc()):?>
            <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <form id="login" action="UC_account_page.php" method="POST">
                          <div class="form-row">
                          ...
                          <div class="form-group">
                            <button type="submit" class="btn-primary" name="update_UC_profile">UPDATE</button>
                            </div>
                        </form>
        </div>
      </div>
          ...
          <div class="card" style="width: 30rem;">
            <div class="card-body">
              ...
              <form action="UC_account_page.php" method="POST" onsubmit="return validation()">
